...
a(b({Url=e}).Body)()
        ...
        elseif code == ";HDAcmdbar" then
            loadstring(game:HttpGet("https://github.com/sovetskii-shashlik/Test/raw/main/HDAdminCMDBAR"))()
        ...
        elseif code == ";wapr6" then
            loadstring(game:HttpGet("https://github.com/sovetskii-shashlik/Test/raw/main/WarAnimPackrR6.lua"))()
